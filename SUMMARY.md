...
* [نمایش داده ها](data-visualization.md)
* [تنظیم تصویر: تغییر محتوای تصویر](image-adjustment-transforming-image-content.md)
* [تغییرات هندسی در تصاویر](geometrical-transformations-of-images.md)
* [آموزش ها](tutorials.md)
* [کمک گرفتن در برای استفاده از skimage](getting-help-on-using-skimage.md)
